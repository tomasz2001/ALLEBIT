...
import { idlFactory } from './test2_frontend.did.js';
export { idlFactory } from './test2_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TEST2_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test2_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test2_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test2_frontend.did.js")._SERVICE>}
 */
export const test2_frontend = createActor(canisterId);
